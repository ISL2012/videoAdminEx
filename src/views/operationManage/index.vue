<template>
	<div class="operationManage-index">
                ...
                <el-form ref="screenForm" :model="screenForm" :inline="true">
                    <el-form-item>
                        <el-select v-model="screenForm.organizationId" placeholder="请选择单位" class="screen-option">
                            <el-option :label="item.name" :value="item.organizationId" v-for="(item, i) in organizationArr" :key="i"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item>
                        <el-select v-model="screenForm.opType" placeholder="请选择操作类型" class="screen-option">
                            <el-option :label="item.name" :value="item.code" v-for="(item, i) in opTypeArr" :key="i"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item>
                    ...
                    <el-form-item>
                        <el-input v-model="screenForm.keyWord" placeholder="url" class="screen-option"></el-input>
                    </el-form-item>
        ...
        <el-table :data="tableData" style="margin: 24px 0" :header-row-style="{height: '68px'}" 
            ...
            <el-table-column prop="firstMenu" label="一级菜单"></el-table-column>
            <el-table-column prop="secondaryMenu" label="二级菜单"></el-table-column>
            <el-table-column prop="opTypeName" label="操作类型"></el-table-column>
            <el-table-column prop="acUrl" label="请求url"></el-table-column>
            <el-table-column prop="acUrlMemo" label="url描述"></el-table-column>
...
export default {
	...
	methods: {
        ...
        getList() {
            this.$store.dispatch("systemSetup/operationList", {
